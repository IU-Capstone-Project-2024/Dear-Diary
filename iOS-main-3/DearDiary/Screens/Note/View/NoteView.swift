...
final class NoteView: UIView {
    ...
    private(set) lazy var helpButton: UIImageView = {
        let image = UIImageView()
        image.image = UIImage(resource: .help)
    ...
    private func setupView() {
        ...
        [contentWrapperView, helpButton, saveNoteButton].forEach(contentView.addSubview)
