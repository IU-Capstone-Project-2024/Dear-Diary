...
class OnboardingViewController: UIViewController {
    ...
    private let pages = [
        ...
        OnboardingPage(imageName: "7", title: "Privacy Assurance", description: "Your privacy is our main priority. Rest assured, none of your thoughts or data will be sent elsewhere.")
    ]
